...
extern "C" void Filter_HW(__cosim_s40__*, int, int);
extern "C" void apatb_Filter_HW_hw(volatile void * __xlx_apatb_param_Input, volatile void * __xlx_apatb_param_Output) {
  ...
  vector<sc_bv<512> >__xlx_Input_Output__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    ...
    __xlx_Input_Output__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  int __xlx_offset_byte_param_Output = 1*64;
  __cosim_s40__* __xlx_Input_Output__input_buffer= new __cosim_s40__[__xlx_Input_Output__tmp_vec.size()];
  for (int i = 0; i < __xlx_Input_Output__tmp_vec.size(); ++i) {
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+0] = __xlx_Input_Output__tmp_vec[i].range(63, 0).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+1] = __xlx_Input_Output__tmp_vec[i].range(127, 64).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+2] = __xlx_Input_Output__tmp_vec[i].range(191, 128).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+3] = __xlx_Input_Output__tmp_vec[i].range(255, 192).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+4] = __xlx_Input_Output__tmp_vec[i].range(319, 256).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+5] = __xlx_Input_Output__tmp_vec[i].range(383, 320).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+6] = __xlx_Input_Output__tmp_vec[i].range(447, 384).to_uint64();
    ((long long*)__xlx_Input_Output__input_buffer)[i*8+7] = __xlx_Input_Output__tmp_vec[i].range(511, 448).to_uint64();
  }
  // DUT call
...
// print __xlx_apatb_param_Input
  ...
  for (int i = 0; i < __xlx_size_param_Input; ++i) {
    char* start = (char*)(&(__xlx_Input_Output__input_buffer[__xlx_offset_param_Input]));
...
// print __xlx_apatb_param_Output
  ...
  for (int i = 0; i < __xlx_size_param_Output; ++i) {
    char* start = (char*)(&(__xlx_Input_Output__input_buffer[__xlx_offset_param_Output]));
