...
entity Filter_HW_read_input_13 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter_HW_read_input_13 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln25_fu_173_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal ap_block_state72_pp0_stage0_iter0 : BOOLEAN;
    signal ap_predicate_op185_read_state73 : BOOLEAN;
    ...
    signal gmem_addr_read_reg_239 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_flush_enable : STD_LOGIC;
    signal ap_condition_pp0_exit_iter1_state73 : STD_LOGIC;
    signal ap_phi_mux_empty_36_phi_fu_147_p4 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_phi_reg_pp0_iter2_empty_36_reg_144 : STD_LOGIC_VECTOR (511 downto 0);
    signal zext_ln25_fu_195_p1 : STD_LOGIC_VECTOR (511 downto 0);
    signal sext_ln25_fu_163_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln25_fu_185_p1 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln25_fu_179_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_121 <= add_ln25_fu_173_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                shiftreg_i_i_i_i_reg_132 <= ap_phi_mux_empty_36_phi_fu_147_p4(511 downto 8);
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                gmem_addr_read_reg_239 <= m_axi_gmem_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln25_fu_179_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                icmp_ln25_reg_231 <= icmp_ln25_fu_179_p2;
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_ARREADY, Input_r_empty_n, Output_r_empty_n, Output_out_full_n, ap_CS_fsm_state2, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    add_ln25_fu_173_p2 <= std_logic_vector(unsigned(i_reg_121) + unsigned(ap_const_lv17_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_gmem_RVALID, inStream_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln25_reg_231_pp0_iter1_reg, ap_predicate_op185_read_state73)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem_RVALID = ap_const_logic_0)) or ((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_full_n = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_gmem_RVALID, inStream_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln25_reg_231_pp0_iter1_reg, ap_predicate_op185_read_state73)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem_RVALID = ap_const_logic_0)) or ((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_full_n = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_gmem_RVALID, inStream_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln25_reg_231_pp0_iter1_reg, ap_predicate_op185_read_state73)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem_RVALID = ap_const_logic_0)) or ((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_full_n = ap_const_logic_0)));
    end process;
    ...
    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_gmem_RVALID, ap_predicate_op185_read_state73)
    begin
                ap_block_state73_pp0_stage0_iter1 <= ((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (m_axi_gmem_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter2_assign_proc : process(inStream_full_n, icmp_ln25_reg_231_pp0_iter1_reg)
    begin
                ap_block_state74_pp0_stage0_iter2 <= ((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (inStream_full_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln25_fu_179_p2, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln25_fu_179_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_phi_mux_empty_36_phi_fu_147_p4_assign_proc : process(icmp_ln25_reg_231_pp0_iter1_reg, icmp_ln174_reg_235_pp0_iter1_reg, gmem_addr_read_reg_239, ap_phi_reg_pp0_iter2_empty_36_reg_144, zext_ln25_fu_195_p1)
    begin
        if ((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0)) then
            if ((icmp_ln174_reg_235_pp0_iter1_reg = ap_const_lv1_0)) then 
                ap_phi_mux_empty_36_phi_fu_147_p4 <= zext_ln25_fu_195_p1;
            elsif ((icmp_ln174_reg_235_pp0_iter1_reg = ap_const_lv1_1)) then 
                ap_phi_mux_empty_36_phi_fu_147_p4 <= gmem_addr_read_reg_239;
            else 
                ap_phi_mux_empty_36_phi_fu_147_p4 <= ap_phi_reg_pp0_iter2_empty_36_reg_144;
            end if;
        else 
            ap_phi_mux_empty_36_phi_fu_147_p4 <= ap_phi_reg_pp0_iter2_empty_36_reg_144;
        end if; 
    ...
    ap_phi_reg_pp0_iter2_empty_36_reg_144 <= "";

    ap_predicate_op185_read_state73_assign_proc : process(icmp_ln25_reg_231, icmp_ln174_reg_235)
    begin
                ap_predicate_op185_read_state73 <= ((icmp_ln174_reg_235 = ap_const_lv1_1) and (icmp_ln25_reg_231 = ap_const_lv1_0));
    end process;
    ...
    gmem_blk_n_R_assign_proc : process(m_axi_gmem_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln25_reg_231, icmp_ln174_reg_235)
    begin
        if (((icmp_ln174_reg_235 = ap_const_lv1_1) and (icmp_ln25_reg_231 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    icmp_ln174_fu_189_p2 <= "1" when (trunc_ln25_fu_185_p1 = ap_const_lv6_0) else "0";
    icmp_ln25_fu_179_p2 <= "1" when (i_reg_121 = ap_const_lv17_1FA40) else "0";

    inStream_blk_n_assign_proc : process(inStream_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln25_reg_231_pp0_iter1_reg)
    begin
        if (((icmp_ln25_reg_231_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    inStream_din <= ap_phi_mux_empty_36_phi_fu_147_p4(8 - 1 downto 0);

    inStream_write_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln25_reg_231_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem_ARADDR <= sext_ln25_fu_163_p1;
    m_axi_gmem_ARBURST <= ap_const_lv2_0;
    m_axi_gmem_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem_ARID <= ap_const_lv1_0;
    m_axi_gmem_ARLEN <= ap_const_lv32_7E9;
    ...
    m_axi_gmem_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op185_read_state73, ap_block_pp0_stage0_11001)
    begin
        if (((ap_predicate_op185_read_state73 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    begin
        ...
        sext_ln25_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_i_reg_215),64));
    ...
    trunc_ln25_fu_185_p1 <= i_reg_121(6 - 1 downto 0);
    zext_ln25_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shiftreg_i_i_i_i_reg_132),512));
end behav;
