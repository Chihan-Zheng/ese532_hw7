...
module Filter_HW_read_input_13 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [16:0] add_ln25_fu_173_p2;
reg    ap_enable_reg_pp0_iter0;
wire    ap_block_state72_pp0_stage0_iter0;
reg    ap_predicate_op185_read_state73;
...
reg   [511:0] gmem_addr_read_reg_239;
wire    ap_CS_fsm_state71;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_flush_enable;
reg    ap_condition_pp0_exit_iter1_state73;
reg   [511:0] ap_phi_mux_empty_36_phi_fu_147_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_36_reg_144;
wire   [511:0] zext_ln25_fu_195_p1;
wire  signed [63:0] sext_ln25_fu_163_p1;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_01001;
wire   [5:0] trunc_ln25_fu_185_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        i_reg_121 <= 17'd0;
    end else if (((icmp_ln25_fu_179_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        shiftreg_i_i_i_i_reg_132 <= {{ap_phi_mux_empty_36_phi_fu_147_p4[511:8]}};
    end
end

always @ (posedge ap_clk) begin
    if (((ap_predicate_op185_read_state73 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        gmem_addr_read_reg_239 <= m_axi_gmem_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln25_fu_179_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln25_fu_179_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if ((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln174_reg_235 == 1'd1) & (icmp_ln25_reg_231 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_predicate_op185_read_state73 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op185_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem_RVALID == 1'b0)) | ((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op185_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem_RVALID == 1'b0)) | ((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_predicate_op185_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem_RVALID == 1'b0)) | ((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((ap_predicate_op185_read_state73 == 1'b1) & (m_axi_gmem_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln25_reg_231_pp0_iter1_reg == 1'd0) & (inStream_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter2_empty_36_reg_144 = 'bx;

always @ (*) begin
    ap_predicate_op185_read_state73 = ((icmp_ln174_reg_235 == 1'd1) & (icmp_ln25_reg_231 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign icmp_ln174_fu_189_p2 = ((trunc_ln25_fu_185_p1 == 6'd0) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_179_p2 = ((i_reg_121 == 17'd129600) ? 1'b1 : 1'b0);

assign inStream_din = ap_phi_mux_empty_36_phi_fu_147_p4[7:0];

assign m_axi_gmem_ARADDR = sext_ln25_fu_163_p1;
...
assign m_axi_gmem_ARLEN = 32'd2025;
...
assign sext_ln25_fu_163_p1 = $signed(trunc_ln_i_reg_215);

assign start_out = real_start;

assign trunc_ln25_fu_185_p1 = i_reg_121[5:0];

assign zext_ln25_fu_195_p1 = shiftreg_i_i_i_i_reg_132;

endmodule //Filter_HW_read_input_13
