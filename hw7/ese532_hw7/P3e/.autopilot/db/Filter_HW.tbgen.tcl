...
set C_modelArgList {
	...
	{ aximm2 int 16 regular {axi_master 1}  }
	{ Input_r int 64 regular {axi_slave 0}  }
	{ Output_r int 64 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "aximm1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "Input","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "Input_r","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "aximm2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "Output","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "Output_r","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "6", "15", "16", "17"],
		"CDFG" : "Filter_HW",
		"Protocol" : "ap_ctrl_chain",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "175810", "EstimateLatencyMax" : "445724",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "1",
		...
		"InputProcess" : [
			{"ID" : "4", "Name" : "Filter_horizontal_HW3_U0"}],
		"OutputProcess" : [
			{"ID" : "6", "Name" : "Filter_vertical_HW_U0"}],
		"Port" : [
			{"Name" : "aximm1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "Filter_horizontal_HW3_U0", "Port" : "aximm1"}]},
			{"Name" : "aximm2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Filter_vertical_HW_U0", "Port" : "aximm2"}]},
			{"Name" : "Input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "Output_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "tempStream", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "Filter_horizontal_HW3_U0", "Port" : "tempStream"},
					{"ID" : "6", "SubInstance" : "Filter_vertical_HW_U0", "Port" : "tempStream"}]}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Filter_horizontal_HW3_U0", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			...
			{"Name" : "Input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "Output_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "Output_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "Output_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "tempStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "tempStream_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_horizontal_HW3_U0.mac_muladd_8ns_8ns_16ns_16_4_1_U1", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0", "Parent" : "0", "Child" : ["7", "8", "9", "10", "11", "12", "13", "14"],
		"CDFG" : "Filter_vertical_HW",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "5998", "EstimateLatencyMax" : "275912",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "Output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "Output_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "tempStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "tempStream_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_0_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_1_U", "Parent" : "6"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_2_U", "Parent" : "6"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_3_U", "Parent" : "6"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_4_U", "Parent" : "6"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_5_U", "Parent" : "6"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.Input_local_6_U", "Parent" : "6"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Filter_vertical_HW_U0.mac_muladd_8ns_8ns_16ns_16_4_1_U8", "Parent" : "6"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Output_c_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tempStream_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Filter_vertical_HW_U0_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Filter_HW {
		aximm1 {Type I LastRead 147 FirstWrite -1}
		aximm2 {Type O LastRead 10 FirstWrite 9}
	...
	Filter_vertical_HW {
		aximm2 {Type O LastRead 10 FirstWrite 9}
		Output_r {Type I LastRead 0 FirstWrite -1}
		tempStream {Type I LastRead 474 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "175810", "Max" : "445724"}
	, {"Name" : "Interval", "Min" : "170372", "Max" : "275913"}
]}
