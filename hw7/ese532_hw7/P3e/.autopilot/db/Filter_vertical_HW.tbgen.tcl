...
set C_modelArgMapList {[ 
	{ "Name" : "aximm2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axi_aximm2_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_AWADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_aximm2_AWID sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_AWLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_aximm2_AWSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_aximm2_AWBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_aximm2_AWLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_aximm2_AWCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_AWPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_aximm2_AWQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_AWREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_AWUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_WVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_WREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_WDATA sc_out sc_lv 16 signal 0 } 
	{ m_axi_aximm2_WSTRB sc_out sc_lv 2 signal 0 } 
	{ m_axi_aximm2_WLAST sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_WID sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_WUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_ARVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_ARREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_ARADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_aximm2_ARID sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_ARLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_aximm2_ARSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_aximm2_ARBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_aximm2_ARLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_aximm2_ARCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_ARPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_aximm2_ARQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_ARREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_aximm2_ARUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_aximm2_RVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_RREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_RDATA sc_in sc_lv 16 signal 0 } 
	{ m_axi_aximm2_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_aximm2_RUSER sc_in sc_lv 1 signal 0 } 
	{ m_axi_aximm2_RRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_aximm2_BVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_aximm2_BREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_aximm2_BRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_aximm2_BID sc_in sc_lv 1 signal 0 } 
	{ m_axi_aximm2_BUSER sc_in sc_lv 1 signal 0 } 
	{ Output_r_dout sc_in sc_lv 64 signal 1 } 
	{ Output_r_empty_n sc_in sc_logic 1 signal 1 } 
	{ Output_r_read sc_out sc_logic 1 signal 1 } 
	{ tempStream_dout sc_in sc_lv 8 signal 2 } 
	{ tempStream_empty_n sc_in sc_logic 1 signal 2 } 
	{ tempStream_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"Port" : [
			...
			{"Name" : "tempStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "tempStream_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Input_local_0_U", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5998", "Max" : "275912"}
	, {"Name" : "Interval", "Min" : "5998", "Max" : "275912"}
]}
