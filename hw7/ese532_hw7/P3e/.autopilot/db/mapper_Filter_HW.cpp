...
extern "C" void Filter_HW(short*, short*, int, int);
extern "C" void apatb_Filter_HW_hw(volatile void * __xlx_apatb_param_Input, volatile void * __xlx_apatb_param_Output) {
  ...
  // DUT call
  Filter_HW(__xlx_Input__input_buffer, __xlx_Output__input_buffer, __xlx_offset_byte_param_Input, __xlx_offset_byte_param_Output);
