...
HD_PWD='/mnt/castor/seas_home/c/chihan/chihan/ese532_hw7/hw7/_x/link/vivado/vpl/prj/prj.runs/u96v2_sbc_base_Filter_HW_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u96v2_sbc_base_Filter_HW_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u96v2_sbc_base_Filter_HW_1_0.tcl
