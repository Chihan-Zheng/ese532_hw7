...
proc create_root_design { parentCell } {
  ...
  # Create instance: Filter_HW_1, and set properties
  set Filter_HW_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Filter_HW:1.0 Filter_HW_1 ]
  ...
  connect_bd_intf_net -intf_net Filter_HW_1_m_axi_gmem [get_bd_intf_pins Filter_HW_1/m_axi_gmem] [get_bd_intf_pins axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD_M00_AXI [get_bd_intf_pins Filter_HW_1/s_axi_control] [get_bd_intf_pins axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/M00_AXI]
  ...
  connect_bd_net -net Filter_HW_1_interrupt [get_bd_pins Filter_HW_1/interrupt] [get_bd_pins axi_intc_0_intr_1_interrupt_concat/In1]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Filter_HW_1/ap_clk] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/ACLK] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/M00_ACLK] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/S00_ACLK] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins Filter_HW_1/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces Filter_HW_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Filter_HW_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces Filter_HW_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
